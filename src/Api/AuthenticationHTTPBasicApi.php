...
/**
 * AuthenticationHTTPBasicApi Class Doc Comment
 *
 * @category Class
 * @package  Frengky\Fineract
 * @author   Swagger Codegen team
...
class AuthenticationHTTPBasicApi
{
     ...
     * @return \Frengky\Fineract\Model\PostAuthenticationResponse
     */
     ...
     * @throws \Frengky\Fineract\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frengky\Fineract\Model\PostAuthenticationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function authenticateWithHttpInfo($body = null)
    {
        $returnType = '\Frengky\Fineract\Model\PostAuthenticationResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Frengky\Fineract\Model\PostAuthenticationResponse',
