...
/**
 * InteropQuoteRequestData Class Doc Comment
 *
 * @category Class
 * @package  Frengky\Fineract
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InteropQuoteRequestData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InteropQuoteRequestData';
...
'quoteCode' => 'string',
'amountType' => 'string',
'fees' => '\Frengky\Fineract\Model\MoneyData',
...
const AMOUNT_TYPE_SEND = 'SEND';
const AMOUNT_TYPE_RECEIVE = 'RECEIVE';
...
self::TRANSACTION_ROLE_PAYEE,        ];
    ...
    {
        return [
            self::AMOUNT_TYPE_SEND,
self::AMOUNT_TYPE_RECEIVE,        ];
    }
     ...
     * Sets amountType
     *
     * @param string $amountType amountType
     *
     * @return $this
     */
     ...
     * Sets fees
     *
     * @param \Frengky\Fineract\Model\MoneyData $fees fees
     *
     * @return $this
     */
