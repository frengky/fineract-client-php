...
/**
 * InteropTransferResponseData Class Doc Comment
 *
 * @category Class
 * @package  Frengky\Fineract
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InteropTransferResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InteropTransferResponseData';
...
'completedTimestamp' => 'setCompletedTimestamp'    ];
...
'completedTimestamp' => 'getCompletedTimestamp'    ];
...
self::STATE_REJECTED,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transferCode'] = isset($data['transferCode']) ? $data['transferCode'] : null;
    ...
    /**
     * Gets completedTimestamp
     *
     * @return string
     */
    public function getCompletedTimestamp()
    {
        return $this->container['completedTimestamp'];
    }

    /**
     * Sets completedTimestamp
     *
     * @param string $completedTimestamp completedTimestamp
     *
     * @return $this
     */
